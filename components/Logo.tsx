  ...
  return (
    ...
    >
      <g fill={props.fill} fillRule="evenodd">
        <path fill={props.fill} d="M4.611 36.774l17.234-9.318-15.163-1.981z" />
        <path fill={props.fill} d="M0 0v30.792h27.942L38.866 0z" />
        <path fill={props.fill} d="M38.215 0L27.817 30.792H65L64.869 0z" />
        <g fill={props.text}>
