    ...
    <Dialog open={open} onOpenChange={() => onOpenChange(false)}>
      <DialogContent className="max-w-5xl flex flex-col md:justify-center md:items-center md:p-8 h-full md:h-auto overflow-auto">
        ...
        <DialogDescription className="flex flex-col gap-2">
          <span>
            Bienvenido al sitio web "Califica tu Profe" ("el Sitio"). Antes de
            utilizar este Sitio, le recomendamos que lea detenidamente estos
            Términos de Uso ("Términos") para comprender las condiciones que
            rigen su acceso y uso del Sitio. Al acceder o utilizar el Sitio,
            usted acepta estar sujeto a estos Términos. Si no está de acuerdo
            con alguno de los términos, por favor, no utilice el Sitio.
          </span>
          ...
          "Califica tu Profe" permite reseñas anónimas para proteger la
          identidad de los usuarios. Sin embargo, el Sitio puede divulgar
          ...
          Todo el contenido de "Califica tu Profe", incluyendo, pero no limitado
          a texto, gráficos, logotipos, imágenes y software, está protegido por
          ...
          "Califica tu Profe" no se hace responsable de la exactitud, integridad
          o legalidad del contenido de las reseñas. Los usuarios utilizan el
          Sitio bajo su propio riesgo. El Sitio no será responsable por daños
          ...
          "Califica tu Profe" se reserva el derecho de modificar estos Términos
          ...
          tiene alguna pregunta o inquietud, contáctenos en [dirección de correo
          electrónico].
        </DialogDescription>
      </DialogContent>
    </Dialog>
