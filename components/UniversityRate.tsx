...
import { formSchema } from "../app/(profile)/universidad/[id]/calificar/constants";

const UniversityRate = ({ params }: { params: { id: string } }) => {
                ...
                <FormControl>
                  <>
                    ...
                    >
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-l-3xl h-12 w-16 bg-gray-200 hover:bg-red-400/70 cursor-pointer border border-white",
                            (safety >= 1 || hoverSafety >= 1) && "bg-red-400"
                          )}
                          onClick={() => {
                            setSafety(1);
                            setSelectedSafety(1);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-orange-400/70 cursor-pointer border border-white",
                            (safety >= 2 || hoverSafety >= 2) && "bg-orange-400"
                          )}
                          onClick={() => {
                            setSafety(2);
                            setSelectedSafety(2);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-yellow-400/70 cursor-pointer border border-white",
                            (safety >= 3 || hoverSafety >= 3) && "bg-yellow-400"
                          )}
                          onClick={() => {
                            setSafety(3);
                            setSelectedSafety(3);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-green-400/70 cursor-pointer border border-white",
                            (safety >= 4 || hoverSafety >= 4) && "bg-green-400"
                          )}
                          onClick={() => {
                            setSafety(4);
                            setSelectedSafety(4);
                    ...
                    {hoverSafety ? (
                      <div className="flex mx-auto justify-center w-full font-medium text-sm text-muted-foreground">
                        {hoverSafety} -{" "}
                        {rate.find((r) => r.id === hoverSafety)?.description}
                      </div>
                    ) : (
                      <>
                        {selectedSafety ? (
                ...
                <FormControl>
                  <>
                    ...
                    {hoverInternet ? (
                      <div className="flex mx-auto justify-center w-full font-medium text-sm text-muted-foreground">
                        {hoverInternet} -{" "}
                        {rate.find((r) => r.id === hoverInternet)?.description}
                      </div>
                    ) : (
                      <>
                        {selectedInternet ? (
                ...
                <FormControl>
                  <>
                    ...
                    {hoverLocation ? (
                      <div className="flex mx-auto justify-center w-full font-medium text-sm text-muted-foreground">
                        {hoverLocation} -{" "}
                        {rate.find((r) => r.id === hoverLocation)?.description}
                      </div>
                    ) : (
                      <>
                        {selectedLocation ? (
                    ...
                    >
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-l-3xl h-12 w-16 bg-gray-200 hover:bg-red-400/70 cursor-pointer border border-white",
                            (opportunities >= 1 || hoverOpportunities >= 1) &&
                              "bg-red-400"
                          )}
                          onClick={() => {
                            setOpportunities(1);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-orange-400/70 cursor-pointer border border-white",
                            (opportunities >= 2 || hoverOpportunities >= 2) &&
                              "bg-orange-400"
                          )}
                          onClick={() => {
                            setOpportunities(2);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-yellow-400/70 cursor-pointer border border-white",
                            (opportunities >= 3 || hoverOpportunities >= 3) &&
                              "bg-yellow-400"
                          )}
                          onClick={() => {
                            setOpportunities(3);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-green-400/70 cursor-pointer border border-white",
                            (opportunities >= 4 || hoverOpportunities >= 4) &&
                              "bg-green-400"
                          )}
                          onClick={() => {
                            setOpportunities(4);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-r-3xl h-12 w-16 bg-gray-200 hover:bg-green-600/70 cursor-pointer border border-white",
                            (opportunities >= 5 || hoverOpportunities >= 5) &&
                              "bg-green-600"
                          )}
                          onClick={() => {
                            setOpportunities(5);
                      ...
                      <>
                        {selectedOpportunities ? (
                          <div className="flex mx-auto justify-center w-full font-medium text-sm">
                            {selectedOpportunities} -{" "}
                            {
                              rate.find((r) => r.id === selectedOpportunities)
                                ?.description
                            }
                          </div>
                        ) : (
                ...
                <FormControl>
                  <>
                    ...
                    {hoverHappiness ? (
                      <div className="flex mx-auto justify-center w-full font-medium text-sm text-muted-foreground">
                        {hoverHappiness} -{" "}
                        {rate.find((r) => r.id === hoverHappiness)?.description}
                      </div>
                    ) : (
                      <>
                        {selectedHappiness ? (
                ...
                <FormControl>
                  <>
                    ...
                    >
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-l-3xl h-12 w-16 bg-gray-200 hover:bg-red-400/70 cursor-pointer border border-white",
                            (social >= 1 || hoverSocial >= 1) && "bg-red-400"
                          )}
                          onClick={() => {
                            setSocial(1);
                            setSelectedSocial(1);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-orange-400/70 cursor-pointer border border-white",
                            (social >= 2 || hoverSocial >= 2) && "bg-orange-400"
                          )}
                          onClick={() => {
                            setSocial(2);
                            setSelectedSocial(2);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-yellow-400/70 cursor-pointer border border-white",
                            (social >= 3 || hoverSocial >= 3) && "bg-yellow-400"
                          )}
                          onClick={() => {
                            setSocial(3);
                            setSelectedSocial(3);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-green-400/70 cursor-pointer border border-white",
                            (social >= 4 || hoverSocial >= 4) && "bg-green-400"
                          )}
                          onClick={() => {
                            setSocial(4);
                            setSelectedSocial(4);
                    ...
                    {hoverSocial ? (
                      <div className="flex mx-auto justify-center w-full font-medium text-sm text-muted-foreground">
                        {hoverSocial} -{" "}
                        {rate.find((r) => r.id === hoverSocial)?.description}
                      </div>
                    ) : (
                      <>
                        {selectedSocial ? (
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-r-3xl h-12 w-16 bg-gray-200 hover:bg-green-600/70 cursor-pointer border border-white",
                            (food === 5 || hoverFood === 5) && "bg-green-600"
                          )}
                          onClick={() => {
                            setFood(5);
                            setSelectedFood(5);
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-orange-400/70 cursor-pointer border border-white",
                            (clubs >= 2 || hoverClubs >= 2) && "bg-orange-400"
                          )}
                          onClick={() => {
                            setClubs(2);
                            setSelectedClubs(2);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-yellow-400/70 cursor-pointer border border-white",
                            (clubs >= 3 || hoverClubs >= 3) && "bg-yellow-400"
                          )}
                          onClick={() => {
                            setClubs(3);
                            setSelectedClubs(3);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-none h-12 w-16 bg-gray-200 hover:bg-green-400/70 cursor-pointer border border-white",
                            (clubs >= 4 || hoverClubs >= 4) && "bg-green-400"
                          )}
                          onClick={() => {
                            setClubs(4);
                            setSelectedClubs(4);
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <Label
                          ...
                          className={cn(
                            "rounded-r-3xl h-12 w-16 bg-gray-200 hover:bg-green-600/70 cursor-pointer border border-white",
                            (clubs === 5 || hoverClubs === 5) && "bg-green-600"
                          )}
                          onClick={() => {
                            setClubs(5);
                            setSelectedClubs(5);
