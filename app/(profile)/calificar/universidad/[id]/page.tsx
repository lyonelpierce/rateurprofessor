                ...
                <FormItem className="border p-4 shadow-md rounded-md">
                  ...
                  <FormControl>
                    <>
                      ...
                      {hoverFacilities ? (
                        <div className="flex mx-auto justify-center w-1/3 font-medium text-sm text-muted-foreground">
                          {hoverFacilities} -{" "}
                          {
                        ...
                        <>
                          {selectedFacilities ? (
                            <div className="flex mx-auto justify-center w-1/3 font-medium text-sm">
                              {selectedFacilities} -{" "}
                              {
