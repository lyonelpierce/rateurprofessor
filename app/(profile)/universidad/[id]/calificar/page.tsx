                              ...
                              >
                                <div className="flex flex-col justify-center items-center">
                                  ...
                                  <Label
                                    ...
                                    onMouseEnter={() =>
                                      setHoverOpportunities(1)
                                    }
                                    onMouseLeave={() =>
                                      setHoverOpportunities(0)
                                    }
                                  />
                                </div>
                                <div className="flex flex-col justify-center items-center">
